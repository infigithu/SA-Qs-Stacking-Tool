...
CHAPTER_LIST = """Units & Dimensions, Motion in One Dimension, Motion in Two Dimensions (Projectile Motion), Laws of Motion, Work Power & Energy, Centre of Mass, Rotational Motion, Gravitation, SHM, Waves (Sound & Mechanical), Kinetic Theory of Gases, Thermodynamics, Heat Transfer, Current Electricity, Capacitance, Moving Charges & Magnetism, Magnetism & Matter, Electromagnetic Induction, Alternating Current, Ray Optics, Wave Optics, Dual Nature of Matter & Radiation, Atoms & Nuclei, Semiconductor Electronics, Communication Systems, Sets Relations & Functions, Complex Numbers, Quadratic Equations, Permutations & Combinations, Matrices & Determinants, Probability, Statistics, Limits & Continuity, Differentiation, Application of Derivatives, Definite Integrals, Differential Equations, Straight Lines, Circles, Parabola, Hyperbola, Ellipse, Vectors 2D, Vector 3D, Properties of Triangles, Heights & Distances, Functions, Circular Motion, Fluid Mechanics, Inverse Trignometry, Sequences & Series, Trigonometric Ratios & Identities, Indefinite Integrals, Electrostatics, Binomial Theorem, Applications of Derivatives, Sequence & Series, Principles of Communcation"""
